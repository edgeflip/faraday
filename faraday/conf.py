...
DEFAULTS = (
    ...
    ('MOCK_HOST', 'FARADAY_MOCK_HOST', 'localhost:4567'),
    ('MOCK_PATH', 'FARADAY_MOCK_PATH', None),
    ('MOCK_PID', 'FARADAY_MOCK_PID', None),
    ('MOCK_DB', 'FARADAY_MOCK_DB', None),
    ('MOCK_MEMORY', 'FARADAY_MOCK_MEMORY', False),
    ('MOCK_DOWNLOAD_URL', 'FARADAY_MOCK_DOWNLOAD_URL',
